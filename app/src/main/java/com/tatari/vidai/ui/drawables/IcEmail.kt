...
public val Icons.IcEmail: ImageVector
    get() {
        if (_icEmail != null) {
            return _icEmail!!
        }
        _icEmail = Builder(name = "IcEmail", defaultWidth = 20.0.dp, defaultHeight = 16.0.dp,
...
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = Icons.IcEmail, contentDescription = "")
    }
}
