...
public val Icons.IcLockSelected: ImageVector
    get() {
        if (_icLockSelected != null) {
            return _icLockSelected!!
        }
        _icLockSelected = Builder(name = "IcLockSelected", defaultWidth = 19.0.dp, defaultHeight =
            ...
            path(fill = null, stroke = SolidColor(Color(0xFF455AF7)), strokeLineWidth = 1.5625f,
            ...
            path(fill = SolidColor(Color(0xFFD3CFEB)), stroke = SolidColor(Color(0xFF455AF7)),
                    ...
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(9.5f, 14.84f)
                curveToRelative(0.592f, 0.0f, 1.073f, -0.481f, 1.073f, -1.073f)
                curveToRelative(0.0f, -0.593f, -0.481f, -1.073f, -1.073f, -1.073f)
                curveToRelative(-0.593f, 0.0f, -1.073f, 0.48f, -1.073f, 1.073f)
...
private var _icLockSelected: ImageVector? = null

@Preview
@Composable
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = Icons.IcLockSelected, contentDescription = "")
    }
}
